...
const Header = () => {
    ...
    const data = {
        ...
        img: "./react-landing-page/illustration-grow-together.svg",
        ...
        img1: "./react-landing-page/illustration-flowing-conversation.svg",
        name2: "Your Users",
        ...
        img2:"./react-landing-page/illustration-your-users.svg",
    }
